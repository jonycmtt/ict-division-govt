...
const Footer = () => {
  return (
    ...
    >
        ...
        <footer className="footer p-10 items-center">
          <nav>
            ...
            <span className="italic">
              Site was last updated: 2024-08-15 12:38:50
            </span>
          </nav>
          ...
          <nav>
            <div>
              ...
              <ul className="flex gap-2 my-1 text-[#ddd] montserrat">
                ...
                <li className="flex items-center gap-1">
                  <FaAngleRight />
                  <a className="link link-hover"> DOICT</a>
                </li>
                <li className="flex items-center gap-1">
                  <FaAngleRight />
            ...
            <form>
              <h6 className="text-lg font-bold montserrat">Newsletter</h6>
              <fieldset className="form-control w-80">
                <label className="label">
                  <span className="text-[#ddd]">Enter your email address</span>
                </label>
                <div className="join">
                  <input
                    type="text"
      ...
      <footer className="footer border-t border-slate-500 items-center p-4">
